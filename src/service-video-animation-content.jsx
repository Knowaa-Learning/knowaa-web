...
function VideoAnimationContent() {
  const r1 = useReveal();
  const r3 = useReveal();
  const r4 = useReveal();
  const r5 = useReveal();
      ...
      <section className="ce__sec ce__sec--grid">
        <div className="ce__inner ce__inner--wide">
          <div className="ce__grid">
            {[
              { name: 'Explainer Videos',              sub: 'Short, focused modules', icon: 'assets/icons/video-animation/explainer.svg', tint: '#EDE7F6' },
              { name: 'Scenario-Based Learning',       sub: 'Practice in context', icon: 'assets/icons/video-animation/scenario.svg', tint: '#FFE9DC' },
              { name: 'Onboarding',                    sub: 'Routed to the gap', icon: 'assets/icons/video-animation/onboarding.svg', tint: '#E3E1F7' },
              { name: 'Microlearning Videos',          sub: 'Personalized at scale', icon: 'assets/icons/video-animation/microlearning.svg', tint: '#E0F2EE' },
              { name: '3D Animation',                  sub: 'Studio-grade craft', icon: 'assets/icons/video-animation/3d.svg', tint: '#FCE4EC' },
              { name: 'Interactive Video Simulations', sub: 'Practice in context', icon: 'assets/icons/video-animation/interactive.svg', tint: '#E1ECFB' },
              { name: 'Whiteboard Animation',          sub: 'Sketched, step by step', icon: 'assets/icons/video-animation/whiteboard.svg', tint: '#FFF6D9' },
              { name: 'System Walkthroughs',           sub: 'Show the actual product', icon: 'assets/icons/video-animation/system-walkthrough.svg', tint: '#E6F2FF' },
              { name: 'Talking Head',                  sub: 'A real human, on camera', icon: 'assets/icons/video-animation/talking-head.svg', tint: '#F3ECFE' },
            ].map((c) => (
...
Object.assign(window, { VideoAnimationContent });
