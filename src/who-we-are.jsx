    ...
    <section ref={sectionRef} className="who-we-are" aria-labelledby="who-we-are-title">
        ...
        <div className="who-we-are__text">
          ...
          <ul className="who-we-are__stats" aria-label="Knowaa at a glance">
            ...
            <li className="who-we-are__stat">
              ...
              <span className="who-we-are__stat-label">Projects delivered</span>
            </li>
            <li className="who-we-are__stat">
              <span className="who-we-are__stat-number" data-count-to="50">+50</span>
              <span className="who-we-are__stat-label">Global enterprises</span>
            </li>
          </ul>
        </div>
      ...
      <style>{`
        ...
        .who-we-are__title {
          ...
          letter-spacing: -0.02em; margin: 0 0 24px; color: #111111;
        }
